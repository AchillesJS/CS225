...
Graph PremadeGraphs::createChinaMap(bool isWeighted)
{
    ...
    g.insertEdge(vertices[1], vertices[9]);  
    g.insertEdge(vertices[8], vertices[3]);  
    g.insertEdge(vertices[1], vertices[2]); 
    g.insertEdge(vertices[2], vertices[3]); 
    g.insertEdge(vertices[2], vertices[4]);  
    ...
    if (isWeighted) {
        g.setEdgeWeight(vertices[0], vertices[1], 1064);
        g.setEdgeWeight(vertices[0], vertices[6], 1050);
        g.setEdgeWeight(vertices[0], vertices[7],  910);
        g.setEdgeWeight(vertices[1], vertices[8],  170);
        g.setEdgeWeight(vertices[1], vertices[9],  275);
        g.setEdgeWeight(vertices[8], vertices[3], 1080);
        g.setEdgeWeight(vertices[1], vertices[2], 1200);
        g.setEdgeWeight(vertices[2], vertices[3],  110);
        g.setEdgeWeight(vertices[2], vertices[4], 1230);
        g.setEdgeWeight(vertices[3], vertices[4], 1520);
        g.setEdgeWeight(vertices[4], vertices[5],  280);
        g.setEdgeWeight(vertices[5], vertices[7],  505);
        g.setEdgeWeight(vertices[6], vertices[5],  750);
        g.setEdgeWeight(vertices[6], vertices[9],  580);
    }
